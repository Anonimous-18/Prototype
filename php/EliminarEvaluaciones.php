...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $consulta = "DELETE FROM evaluacionescrear WHERE id = :id";
        $statement = $conn->prepare($consulta);      
        $statement->bindParam(':id', $id);
        $statement->execute();

        echo 'evaluacion eliminada exitosamente';
    } catch (PDOException $e) {
        echo 'Error al eliminar el evaluaciones: ' . $e->getMessage();
    }
...
<head>
    ...
    <title>Eliminar evaluaciones </title>
